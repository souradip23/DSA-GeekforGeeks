<h2><a href="https://www.geeksforgeeks.org/problems/longest-palindromic-subsequence-1612327878/1">Longest Palindromic Subsequence</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color); --text-color-night-eye: var(--problem-text-color-night-eye);"><p><span style="font-size: 14pt; font-family: 'andale mono', monospace;">Given a string <strong>s</strong>, return the <strong>length </strong>of the longest palindromic subsequence.<br>A subsequence is a sequence that can be derived from the given sequence by deleting some or no elements without changing the order of the remaining elements. <br>A palindromic sequence is a sequence that reads the same forward and backward.</span></p>
